  ...
  <div class="home-page">
    <div class="home-header">
      <div class="con">
        ...
        <div class="search"><SvgMap name="home-search" /> 搜一搜：疾病/症状/医生/健康知识</div>
      </div>
    </div>
    <div class="home-navs">
      <van-row>
        <van-col span="8">
          <router-link to="/" class="nav">
            <SvgMap name="home-doctor"></SvgMap>
            <p class="title">问医生</p>
        ...
        <van-col span="8">
          <router-link to="/consult/fast" class="nav" >
            <SvgMap name="home-graphic"></SvgMap>
            <p class="title" @click="store.setType(ConsultType.Fast)">极速问诊</p>
            <p class="desc">20s医生极速回复</p>
          </router-link>
        </van-col>
        <van-col span="8">
          <router-link to="/" class="nav">
            <SvgMap name="home-prescribe"></SvgMap>
      ...
      <van-row>
        <van-col span="6">
          <router-link to="/" class="nav min">
            <SvgMap name="home-order"></SvgMap>
            <p class="title">药品订单</p>
          </router-link>
        </van-col>
        <van-col span="6">
          <router-link to="/" class="nav min">
            <SvgMap name="home-docs"></SvgMap>
            <p class="title">健康档案</p>
          </router-link>
        </van-col>
        <van-col span="6">
          <router-link to="/" class="nav min">
            <SvgMap name="home-rp"></SvgMap>
            <p class="title">我的处方</p>
          </router-link>
        </van-col>
        <van-col span="6">
          <router-link to="/" class="nav min">
            <SvgMap name="home-find"></SvgMap>
